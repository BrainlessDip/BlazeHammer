...
class SimpleExampleProvider(BaseProvider):
    def simple_example(self, category=None):
        ...
        return self.random_element(texts['greetings'])  # Default to greeting if no category

class AdvancedExampleProvider(BaseProvider):
    def advanced_example(self, category=None, language='en', length=5, complexity='medium'):
        """
        ...
        texts = {
            'en': {
                ...
                'places': ['New York', 'London', 'Paris', 'Dhaka', 'Tokyo']  # Corrected 'places'
            },
            'bn': {
                ...
                'places': ['ঢাকা', 'চট্টগ্রাম', 'রাজশাহী', 'বরিশাল', 'কুমিল্লা']  # Corrected 'places'
            }
        }
